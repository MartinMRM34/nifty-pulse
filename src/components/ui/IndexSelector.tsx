    ...
    <div className="flex flex-wrap gap-3">
      {INDICES.map((index) => (
        <button
          ...
          className={`relative group flex flex-col items-start px-4 py-2.5 rounded-xl border transition-all duration-200 sm:min-w-[130px] ${selected === index.id
        ...
        >
          ...
          <span className={`text-[11px] mt-1 whitespace-nowrap ${selected === index.id ? "text-blue-100" : "text-gray-500"
            }`}>
            {index.name}
          </span>
